...
public class BoomCrossbowFire : GunFire
{
    public override void Fire(LayerMask Shooter, Vector3 Direction, Vector3 StartPosition, int DMG = 0, int KnockBack = 0)
    {
        ...
        Bullet bullet = ObjectPoolManager.Instance.GetObject(ObjectPoolType.Water_Bomb, this.transform.position).GetComponent<Bullet>();
        bullet.Damage = DMG;
